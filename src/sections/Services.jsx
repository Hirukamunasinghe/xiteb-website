...
const Services =() =>{
    return (
        <div className="mt-[100px]">
            <h1 className="text-center text-2xl font-bold text-green-600">Real Solution,Real Fast !</h1>
            <h1 className="text-center mt-[20px] font-bold text-black text-5xl">Best Global Logistics Solutions</h1>
            <div className="cards-div flex justify-center gap-[100px] mt-[100px]">
                <div className="w-[800px] h-[395px] bg-white grid grid-cols-2 shadow-lg cursor-pointer">
                    ...
                    <div className="text-div mt-[80px] flex flex-col gap-[30px] ml-[30px]">
                        <h1 className="text-black font-bold text-3xl">Air Freight Services</h1>
                        <h2 className="text-lg">At our Auto Service garage, we are <br/> fully appreciate how difficult occur <br/> it is for people to find</h2>
                        <div className="flex gap-[6px]">
                        <FontAwesomeIcon className="rounded-full bg-black p-[5px]" icon={faArrowRight} style={{color:'white'}}/>
                        <h3 className="text-lg font-bold">Read More</h3>
                        </div>
                    </div>
                </div>
                <div className="w-[800px] h-[395px] bg-white grid grid-cols-2 shadow-lg cursor-pointer">
                    ...
                    <div className="text-div mt-[80px] flex flex-col gap-[30px] ml-[30px]">
                        <h1 className="text-black font-bold text-3xl">Drone Services</h1>
                        <h2 className="text-lg">At our Auto Service garage, we are <br/> fully appreciate how difficult occur <br/> it is for people to find</h2>
                        <div className="flex gap-[6px]">
                        <FontAwesomeIcon className="rounded-full bg-black p-[5px]" icon={faArrowRight} style={{color:'white'}}/>
                        <h3 className="text-lg font-bold">Read More</h3>
            ...
            <div className="flex justify-between">
                <div className="flex gap-[10px] ml-[350px] mt-[30px]">
                ...
                <div className="flex gap-[10px] mr-[300px] mt-[30px]">
