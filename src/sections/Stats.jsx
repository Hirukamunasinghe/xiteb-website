    ...
    return(
        <div className="mt-[150px]">
            <div className="flex justify-center gap-[140px]">
                ...
                <div>
                    <h1 className="text-9xl font-bold text-gray-100">1 3 7</h1>
                ...
                <div>
                    <h1 className="text-9xl font-bold text-gray-100">7 4 0</h1>
                ...
                <div>
                    <h1 className="text-9xl font-bold text-gray-100">6 6 0</h1>
